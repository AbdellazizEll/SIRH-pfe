...
@Component({
  selector: 'app-responsable-absences',
  templateUrl: './responsable-absences.component.html',
  styleUrls: ['./responsable-absences.component.scss']
})
export class ResponsableAbsencesComponent implements OnInit {
  ...
  loadTabData(): void {
    ...
    this.absenceState$ = this.absenceService.getAbsencesResponsibleWithFilters(
      user.id,
  ...
  approveAbsence(demandeId: number): void {
    ...
    dialogRef.afterClosed().subscribe((confirmed: boolean) => {
      if (confirmed) {
        ...
        this.absenceService.approveAbsenceRequestResponsible(demandeId).subscribe(
          response => {
